export function LobsterMascot({ className = '' }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="lobsterShell" x1="0" x2="1" y1="0" y2="1">
          <stop offset="0%" stopColor="#ff8f4d" />
          <stop offset="100%" stopColor="#ff4f6d" />
        </linearGradient>
      </defs>

      <ellipse cx="110" cy="120" rx="48" ry="62" fill="url(#lobsterShell)" />
      <ellipse cx="110" cy="120" rx="32" ry="48" fill="#ffd0b3" opacity="0.45" />
      ...
      <path d="M95 110 Q110 120 125 110" stroke="#111827" strokeWidth="4" fill="none" strokeLinecap="round" />

      <path d="M64 104 C20 80 22 40 52 34 C65 30 74 38 72 50 C98 52 95 84 64 104 Z" fill="#ff6b54" />
      <path d="M156 104 C200 80 198 40 168 34 C155 30 146 38 148 50 C122 52 125 84 156 104 Z" fill="#ff6b54" />
